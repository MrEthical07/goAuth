...
var CounterDefs = []CounterDef{
	...
	{ID: goAuth.MetricLimiterCheck, Name: "goauth_limiter_check_total", Help: "Limiter checks executed."},
	{ID: goAuth.MetricLimiterTrigger, Name: "goauth_limiter_trigger_total", Help: "Limiter checks that triggered a deny decision."},
	{ID: goAuth.MetricLimiterFailOpen, Name: "goauth_limiter_fail_open_total", Help: "Limiter backend failures handled with fail-open policy."},
	{ID: goAuth.MetricLockoutTrigger, Name: "goauth_lockout_trigger_total", Help: "Automatic lockout threshold triggers."},

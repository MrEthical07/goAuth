...
This file belongs to package `goAuth` and implements part of the goAuth authentication stack. It exists to encapsulate the concerns represented by `builder.go` and keep hot-path auth logic modular.

## 2) Exported API in This File
- `Builder`: public API element defined in this file; see source doc comments for exact behavior, error conditions, and guarantees.
- `New`: public API element defined in this file; see source doc comments for exact behavior, error conditions, and guarantees.

## 3) Internal Interactions
- Depends on imports such as: errors, github.com/MrEthical07/goAuth/internal/rate, github.com/MrEthical07/goAuth/jwt, github.com/MrEthical07/goAuth/password, github.com/MrEthical07/goAuth/permission, github.com/MrEthical07/goAuth/session, github.com/redis/go-redis/v9.
